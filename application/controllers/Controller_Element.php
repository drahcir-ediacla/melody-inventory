...
class Controller_Element extends Admin_Controller 
{
	public function __construct()
	{
		...
		$this->data['page_title'] = 'Variations';
	...
	*/
	public function fetchAttributeData()
	{
		...
		foreach ($data as $key => $value) {
			...
			// button
			$buttons = '<a href="'.base_url('Controller_Element/addvalue/'.$value['id']).'" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Add Value</a> 
